...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Imperial College Healthcare</title>
	    ...
	    <script>
	        $(document).ready(function() {
	          var webAuth = new auth0.WebAuth({
	            ...
	            clientID: 'UTl17U4q16p8n5CsQsyyfjmKTFKqueaR',
	            redirectUri: 'http://imperialcollegehealthcare.com/callback.php', //update to https on here and on auth0 settings
	...
	<body>
        <div>
            <button id="login">Sign Into Imperial College Healthcare with Auth0</button>
        </div>
	</body>
</html>